...
function Header() {
 ...
 <A.Navbar className="bgnavcolor" expand="lg" variant="dark">
  <A.Container>
    <A.Navbar.Brand href="#home">DCXA</A.Navbar.Brand>
    ...
    <A.Navbar.Collapse id="basic-A.Navbar-A.Nav">
      <A.Nav className="me-auto">
        ...
        <A.NavDropdown title="Swap" className="m-2" id="basic-A.Nav-dropdown">
          <A.NavDropdown.Item href="#action/3.1">Swap</A.NavDropdown.Item>
          <A.NavDropdown.Item href="#action/3.2">Add Liquidity</A.NavDropdown.Item>
        ...
        <A.Nav.Link href="#NFTs" className="m-2">NFTs</A.Nav.Link>
